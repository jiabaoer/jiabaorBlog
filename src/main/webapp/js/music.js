!function (t, e) {
    ...
    define
        .amd ? define("skPlayer", [], e) : "object" == typeof exports ? exports.skPlayer = e() : t.skPlayer = e()
}(this, function () {
    return function (t) {
        function e(o) {
        ...
        var s = {
                ...
                ajax: function (t) {
                    ...
                    e.onreadystatechange = function () {
                        4 === e.readyState && (e.status >= 200 && e.status < 300 ? t.success && t.success(e.responseText) : t.fail &&
                            t.fail(e.status))
            ...
            l = function () {
                function t(e) {
                    var n = this;
                    if (o(this, t), i) return //console.error("SKPlayer只能存在一个实例！"),
                    Object.create(null);
                    i = !0;
                    var r = {
                    ...
                    if (this.option = e, !(this.option.music && this.option.music.type && this.option.music.source)) return
                    //console.error("请正确配置对象！"),
                    Object.create(null);
                    this.root = this.option.element, this.type = this.option.music.type, this.music = this.option.music.source,
                        this.isMobile = /mobile/i.test(window.navigator.userAgent), this.toggle = this.toggle.bind(this), this.toggleList =
                        this.toggleList.bind(this), this.toggleMute = this.toggleMute.bind(this), this.switchMode = this.switchMode.bind(
                        this), "file" === this.type ? (this.root.innerHTML = this.template(), this.init(), this.bind()) : "cloud" ===
                        this.type && (this.root.innerHTML = '<p class="skPlayer-tip-loading">正在缓冲中...</p>', s.ajax({
                            ...
                            success: function (t) {
                                //console.log("歌单拉取成功！")
                                n.music = JSON.parse(t), n.root.innerHTML = n.template(), n.init(), n.bind()
                            },
                            fail: function (t) {
                ...
                return r(t, [{
                    ...
                    value: function () {
                        var t = '\n            <audio class="skPlayer-source" src="' + ("file" === this.type ? this.music[0].src :
                            ...
                            '"></i>\n            </div>\n   <div class="container" style="padding-top: 100px;text-align: center;"><span onclick="player.prev();" class="iconfont" style="margin:20px">&#xe66e;</span><span onclick="player.toggle()" class="iconfont" id="toggle" style="margin:20px">&#xe673;</span><span onclick="player.next();" class="iconfont" style="margin:20px">&#xe66f;</span><span onclick="player.toggleList()" class="iconfont" style="margin:20px">&#xe672;</span></div>         <ul class="skPlayer-list">\n        ';
                        for (var e in this.music) t += '\n                <li data-index="' + e +
                            '">\n                    <i class="skPlayer-list-sign"></i>\n                    <span class="skPlayer-list-index">' +
                            (parseInt(e) + 1) + '</span>\n                    <span class="skPlayer-list-name" title="' + this.music[
                                e].name + '">' + this.music[e].name +
                            '</span>\n                    <span class="skPlayer-list-author" title="' + this.music[e].author + '">' +
                            this.music[e].author + "</span>\n                </li>\n            ";
                        return t += "\n            </ul>\n     "
                    }
                }, {
                    key: "init",
                    value: function () {
                        ...
                        this.dom = {
                        ...
                        }, this.audio = this.root.querySelector(".skPlayer-source"), this.option.listshow && (this.root.className =
                            "skPlayer-list-on"), "singleloop" === this.option.mode && (this.audio.loop = !0), this.dom.musicitem[0]
                            .className = "skPlayer-curMusic", "cloud" === this.type && s.ajax({
                            ...
                            success: function (e) {
                                ...
                                null !== n ? (//console.log("歌曲拉取成功！"),
                                    t.audio.src = n) : (//console.log("歌曲拉取失败！ 资源无效！"),
                                    1 !== t.music
                                        .length && t.next())
                            },
                            fail: function (t) {
                    ...
                    value: function () {
                        ...
                        this.updateLine = function () {
                            ...
                            t.dom.timeline_played.style.width = s.percentFormat(n), t.dom.timetext_played.innerHTML = s.timeFormat(
                                t.audio.currentTime)
                            ...
                            "click", this.toggleList), this.isMobile || this.dom.volumebutton.addEventListener("click", this.toggleMute),
                            this.dom.modebutton.addEventListener("click", this.switchMode), this.dom.musiclist.addEventListener(
                            "click",
                            function (e) {
                                var n = void 0,
                                    o = void 0,
                                ...
                                o = parseInt(n.getAttribute("data-index")), r = parseInt(t.dom.musiclist.querySelector(
                                    ".skPlayer-curMusic").getAttribute("data-index")), o === r ? t.play() : t.switchMusic(o + 1)
                            ...
                            isNaN(t.audio.duration) || (t.dom.timeline_played.style.width = s.percentFormat(o), t.dom.timetext_played
                                .innerHTML = s.timeFormat(o * t.audio.duration), t.audio.currentTime = o * t.audio.duration)
                    ...
                    value: function () {
                        ...
                        0 === t ? 1 === this.music.length ? this.play() : this.switchMusic(this.music.length - 1 + 1) : this.switchMusic(
                            t - 1 + 1)
                    }
                }, {
                    key: "next",
                    value: function () {
                        document.getElementById("toggle").innerHTML = "&#xe670;";
                        var t = parseInt(this.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute("data-index"));
                        t === this.music.length - 1 ? 1 === this.music.length ? this.play() : this.switchMusic(1) : this.switchMusic(
                            t + 1 + 1)
                    }
                }, {
                    key: "switchMusic",
                    value: function (t) {
                        var e = this;
                        return "number" != typeof t ? void null//console.error("请输入正确的歌曲序号！")
                            : (t -= 1) < 0 || t >= this.music.length ?
                                void null // console.error("请输入正确的歌曲序号！")
                                : t == this.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute(
                                    "data-index") ? void this.play() : (this.dom.musiclist.querySelector(".skPlayer-curMusic").classList.remove(
                                    "skPlayer-curMusic"), this.dom.musicitem[t].classList.add("skPlayer-curMusic"), this.dom.name.innerHTML =
                                    this.music[t].name, this.dom.author.innerHTML = this.music[t].author, this.dom.cover.src = this.music[
                                    t]
                                    .cover, void("file" === this.type ? (this.audio.src = this.music[t].src, this.play()) : "cloud" ===
                                    this.type && s.ajax({
                                        ...
                                        success: function (t) {
                                            ...
                                            null !== n ? (//console.log("歌曲拉取成功！"),
                                                e.audio.src = n, e.play()) : (//console.log("歌曲拉取失败！ 资源无效！"),
                                            1 !== e.music.length && e.next())
                                        },
                                        fail: function (t) {
                                            //console.error("歌曲拉取失败！ 错误码：" + t)
                                        }
                    ...
                    key: "toggleList",
                    value: function () {
                        this.root.classList.contains("skPlayer-list-on") ? this.root.classList.remove("skPlayer-list-on") : this
                            .root
                            .classList.add("skPlayer-list-on")
                    }
                }, {
                    key: "toggleMute",
                    value: function () {
                        this.audio.muted ? (this.audio.muted = !1, this.dom.volumebutton.classList.remove("skPlayer-quiet"),
                            this
                                .dom.volumeline_value.style.width = s.percentFormat(this.audio.volume)) : (this.audio.muted = !0, this
                            .dom
                            .volumebutton.classList.add("skPlayer-quiet"), this.dom.volumeline_value.style.width = "0%")
                    }
                }, {
                    key: "switchMode",
                    value: function () {
                        this.audio.loop ? (this.audio.loop = !1, this.dom.modebutton.classList.remove("skPlayer-mode-loop")) : (
                            this.audio.loop = !0, this.dom.modebutton.classList.add("skPlayer-mode-loop"))
                    }
                }, {
                    key: "destroy",
                    value: function () {
        ...
        function u(t, e) {
            ...
            typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = l(e), o = h.bind(
                null, n, e), r = function () {
        ...
        t.exports = function (t, e) {
            ...
            e = e || {}, e.attrs = "object" == typeof e.attrs ? e.attrs : {}, e.singleton || (e.singleton = f()), e.insertInto ||
        ...
        t.exports = function (t) {
            ...
            return t.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (t, e) {
                ...
                var s;
                return s = 0 === r.indexOf("//") ? r : 0 === r.indexOf("/") ? n + r : o + r.replace(/^\.\//, ""), "url(" +
                JSON.stringify(s) + ")"
            })
        }
    }])
